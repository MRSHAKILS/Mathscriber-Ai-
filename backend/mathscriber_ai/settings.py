"""
Django settings for mathscriber_ai project.
"""
...
ROOT_URLCONF = 'mathscriber_ai.urls'
...
WSGI_APPLICATION = 'mathscriber_ai.wsgi.application'
...
REST_AUTH = {
    'USE_JWT': False,  # True if you want JWT tokens
}
