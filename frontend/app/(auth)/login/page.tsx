        ...
        <div className="relative bg-neutral-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-8 space-y-6">
          ...
          <div className="relative">
            ...
            <p className="mt-2 text-center text-sm text-neutral-400">
              ...
              <Link href="/register" className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400 hover:from-red-300 hover:to-orange-300 font-semibold transition-all">
                Sign up
              </Link>
            </p>
          </div>
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-red-600 bg-neutral-800 border-neutral-700 rounded focus:ring-red-500 focus:ring-offset-neutral-900"
                />
                <span className="ml-2 text-neutral-400">Remember me</span>
              </label>
