...
export default function CapturePopup({ isOpen, onClose, onConversionComplete }: CapturePopupProps) {
                ...
                <div className="mt-4 flex gap-3">
                  {!capturedImage ? (
                    <button
                      ...
                      className="flex-1 relative px-6 py-3 rounded-xl font-semibold text-white overflow-hidden group"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-orange-600 via-yellow-600 to-orange-600 bg-[length:200%_100%] animate-gradient" />
                    ...
                    <>
                      <button
                        onClick={retake}
                        className="px-4 py-2 rounded-lg border border-red-500/20 text-gray-300 hover:bg-red-600/10 transition-colors flex items-center gap-2"
                      >
                        <RotateCcw size={18} />
                        Retake
                      </button>
